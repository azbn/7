...
<link rel="stylesheet" href="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/css/font-awesome/css/fontawesome-all.min.css');?>" />

<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/jquery-plugin/Azbn7_AjaxUploader.js');?>" ></script>
<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/jquery-plugin/Azbn7_ImageMinimizer.js');?>" ></script>

<!-- jQuery UI 1.12.1 -->
<link href="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/css/jquery-ui-1.12.1/jquery-ui.min.css');?>" rel="stylesheet">
<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/jquery-ui-1.12.1/jquery-ui.min.js');?>" ></script>
...
switch($_SESSION['user']['param']['wysiwyg']) {
	...
	case 'cleditor' : {
		...
		<!-- CLEditor -->
		<link rel="stylesheet" href="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/cleditor/jquery.cleditor.css');?>" />
		<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/cleditor/jquery.cleditor.min.js');?>"></script>
		<script>
		jQuery(function(){
	...
	case 'ckeditor' : {
		...
		<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/ckeditor/ckeditor.js');?>"></script>
		<script>
	...
	case 'tinymce' : {
		...
		<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/tinymce/tinymce.min.js');?>"></script>
		<script>
		jQuery(function(){
...
<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/jquery.azbn7.js');?>" ></script>
<?
/*
...
<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/document-ready.js');?>" ></script>
<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/admin/document-ready.js');?>" ></script>
<!--<script src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/mdl/user.mdl.js');?>" ></script>-->
