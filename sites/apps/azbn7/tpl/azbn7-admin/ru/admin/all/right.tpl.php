...
<h2 class="mt-2 mb-1" >
	...
	<div class="float-sm-right item-base-functions" >
		<a href="<?=$this->Azbn7->mdl('Site')->url('/admin/add/right/');?>" ><i class="fas fa-plus-circle" title="Создать запись" ></i></a>
	</div>
		...
		?>
			...
			<tr>
				...
				<td class="at-center item-edit-functions" >
					<a href="<?=$this->Azbn7->mdl('Site')->url('/admin/edit/right/' . $v['id'] . '/');?>" ><i class="fas fa-pen-square" title="Редактировать" ></i></a>
					<a href="<?=$this->Azbn7->mdl('Site')->url('/admin/delete/right/' . $v['id'] . '/');?>" class="delete-confirm " ><i class="fas fa-times" title="Удалить" ></i></a>
				</td>
			</tr>
