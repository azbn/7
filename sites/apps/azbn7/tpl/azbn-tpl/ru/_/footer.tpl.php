...
<script defer src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/jquery.azbn7.js');?>" ></script>

<script defer src="<?=$this->Azbn7->mdl('Site')->url('/var/static/azbn7/js/document-ready.js');?>" ></script>
